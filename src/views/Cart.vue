<template>
    <div>
                ...
                <li v-for="(item,index) in cartList">
                  <div class="cart-tab-1">
                    <div class="cart-item-check">
                      <a href="javascipt:;" class="checkbox-btn item-check-btn" :class="{'check':item.checked == '0'}" @click="editCart('check',item)">
                  ...
                  <div class="cart-tab-5">
                    <div class="cart-item-opration">
                      <a href="javascript:;" class="item-edit-btn" @click="showDelModal(item)">
            ...
            <div class="cart-foot-inner">
              <div class="cart-foot-l">
                <div class="item-all-check">
                  <a href="javascipt:;" @click="checkAllGoods">
              ...
              <div class="cart-foot-r">
                ...
                <div class="btn-wrap">
                  ...
                  <!--<router-link v-bind:class="{'btn&#45;&#45;dis':checkCount == 0}" class="btn btn&#45;&#45;red" to="/address">Checkout</router-link>-->
                </div>
              </div>
            </div>
          </div>
      ...
      <modal :mdShow="mdShowDel" @closeModal="closeModal">
        <p slot="message">
          您确定要删除此商品么?
        </p>
        <div slot="btnGroup">
          <a href="javascript:;" class="btn btn--m" @click="delConfirm">确定</a>
...
import {mapMutations} from 'vuex';
  ...
  import './../assets/css/checkout.css'
    export default {
      ...
      computed:{
        checkAllFlag(){ //只要选中的数量等于购物车列表个数 就为全选
        ...
        totalPrice(){
          ...
          this.cartList.forEach((item)=>{
            if(item.checked == '0'){
              total += parseFloat(item.productPrice) * parseInt(item.productNum);
            }
