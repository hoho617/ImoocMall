<template>
  <div>
      ...
      <div class="container">
        <div class="checkout-addr">
          ...
          <div class="addr-list-wrap">
            <div class="addr-list">
              <ul>
                <li v-for="(item,index) in addressListFilter" v-bind:class="{'check':index == checkIndex }" @click="checkIndex = index;selectedAddId=item.addressId">
                  <dl>
                    <dt>{{item.userName}}</dt>
                  ...
                  <div class="addr-opration addr-del">
                    <a href="javascript:;" class="addr-del-btn" @click="showDelModal(item.addressId)">
                      <svg class="icon icon-del"><use xlink:href="#icon-del"></use></svg>
                    </a>
                  </div>
                  <div class="addr-opration addr-set-default" v-if="!item.isDefault" @click="setDefaultAddress(item.addressId)">
          ...
          <div class="next-btn-wrap">
            <!--<a class="btn btn&#45;&#45;m btn&#45;&#45;red" @click="toOrderConfirm">Next</a>-->
    ...
    <modal :mdShow="delModalShow" @closeModal="closeModal">
      <p slot="message">
        您是否确认要删除此地址?
      </p>
      <div slot="btnGroup">
            ...
            getAddressList(){
              axios.get('/users/addressList').then((response)=>{
                ...
                if(res.status == "0"){
                  ...
                  this.selectedAddId = res.result.list[0].addressId;
                }
              })
            },
