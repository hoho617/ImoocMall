  ...
  <header class="header">
    ...
    <div class="navbar">
      <div class="navbar-left-container">
        <a href="/">
          <img class="navbar-brand-logo" width="80" src="/static/logo.png">
        </a>
      </div>
    ...
    <div class="md-modal modal-msg md-modal-transition" v-bind:class="{'md-show':loginModalShow}">
    ...
    <div class="md-overlay" v-show="loginModalShow" @click="closeLoginModal"></div> <!---->
  </header>
</template>
      ...
      checkLogin(){
        axios.get('/users/checkLogin').then((response)=>{
          ...
          if(res.status == "0"){
            ...
            let nickName = res.result.userName;
      ...
      getCartCount(){
        axios.get('/users/cartCount').then((response)=>{
          ...
          if(res.status == "0"){
            ...
            let cartCount = res.result.cartCount;
            this.initCartCount(cartCount)
          }
        })
      },
      showLoginModal(){
